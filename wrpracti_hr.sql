...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 13 jan 2020 om 14:03
...
CREATE TABLE `countries` (
  `COUNTRY_ID` varchar(2) CHARACTER SET latin1 NOT NULL,
  `COUNTRY_NAME` varchar(40) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `employees` (
  ...
  `JOB_ID` varchar(10) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `jobs` (
  `JOB_ID` varchar(10) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `JOB_TITLE` varchar(35) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `locations` (
  ...
  `STREET_ADDRESS` varchar(40) CHARACTER SET latin1 DEFAULT NULL,
  `POSTAL_CODE` varchar(12) CHARACTER SET latin1 DEFAULT NULL,
  `CITY` varchar(30) CHARACTER SET latin1 NOT NULL,
  `STATE_PROVINCE` varchar(25) CHARACTER SET latin1 DEFAULT NULL,
  `COUNTRY_ID` varchar(2) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
